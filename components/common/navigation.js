                    ...
                    <div className="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                        ...
                        <div className="hidden sm:block sm:ml-6">
                            <div className="flex space-x-4">
                                <a href="#"
                                   className="bg-main text-white px-3 py-2 rounded-md text-sm font-medium">Dashboard</a>
                                <a href="#"
                                   className="text-gray-500 hover:bg-primary-900 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Team</a>
                                <a href="#"
                                   className="text-gray-500 hover:bg-primary-900 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Projects</a>
                                <a href="#"
                                   className="text-gray-500 hover:bg-primary-900 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Calendar</a>
                            </div>
                        </div>
                    </div>
                    <div
                        ...
                        <div>
                            <button className="bg-main text-white px-3 py-2 rounded-md text-sm font-medium">
                        ...
                        <div className="ml-3 relative">
                            <div>
                                <button type="button"
                                        ...
                                        id="user-menu" aria-expanded="false" aria-haspopup="true" aria-hidden="true">
