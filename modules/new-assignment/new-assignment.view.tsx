...
interface NewAssignmentViewProps {
    ...
    sections: Section[];
    handleSubmit: (body: CreateAssignmentRequestDto) => void;
    handleFile: (e) => void;
    removeFile: (index: number) => void;
    files: Resource[];
}

export default function NewAssignmentView(props: NewAssignmentViewProps) {
                            ...
                            <div className={"px-6 space-y-2.5 overflow-auto h-modal-content overscroll-auto"}>
                                ...
                                <div>
                                    ...
                                    <Field as={"select"} name={"questionType"}>
                                        {[QuestionType.TEXT, QuestionType.UPLOAD].map(type => (
