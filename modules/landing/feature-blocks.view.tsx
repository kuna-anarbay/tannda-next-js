...
export default function FeatureBlocksView() {
    return (
            ...
            <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
                <div className="py-12 md:py-20">
                    ...
                    <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
                        <h2 className="text-title1 font-semibold mb-4">
                            How Simple works
                        </h2>
                    ...
                    <div
                        ...
                        <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
                            ...
                            <p className="text-gray-600 text-center">Lorem ipsum dolor sit amet, consectetur adipiscing
                                elit.</p>
                        </div>
                            ...
                            <svg className="w-16 h-16 p-1 -mt-1 mb-2" viewBox="0 0 64 64"
                                ...
                                <g fill="none" fillRule="evenodd">
                                    ...
                                    <g transform="translate(22.857 19.429)" strokeWidth="2">
                                        ...
                                        <circle className="stroke-current text-blue-300" strokeLinecap="square"
